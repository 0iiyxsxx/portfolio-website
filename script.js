...
const blobDefs = [
  { el: $('#blob1Path'), seed: 0,    speed: 0.0008, cx: 200, cy: 200, r: 155, pts: 8 },
  { el: $('#blob2Path'), seed: 2.1,  speed: 0.0006, cx: 200, cy: 200, r: 150, pts: 7 },
  { el: $('#blob3Path'), seed: 4.3,  speed: 0.0009, cx: 200, cy: 200, r: 145, pts: 8 },
  { el: $('#blob4Path'), seed: 1.4,  speed: 0.0007, cx: 200, cy: 200, r: 140, pts: 9 },
];
...
function animateRing(t) {
  ringSeed += 0.0012;
  if (ringPath) ringPath.setAttribute('d', profileRingPath(ringSeed + t * 0.0004));
